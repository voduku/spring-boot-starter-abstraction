...
@Getter
@Transactional
public abstract class AbstractService<REQUEST, RESPONSE, SEARCH extends AbstractSearch<?>, ENTITY, KEY extends Serializable> implements Service<REQUEST, RESPONSE, SEARCH, KEY> {
